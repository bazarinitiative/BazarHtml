...
export class AccountSwitchAdd extends Component<PropsType, StateType> {
    ...
    render() {
        ...
        return <div>
            <div style={{ "fontSize": "14px", "fontWeight": "600" }}><p>Add an existing account</p></div>
            <div>
                <div>
                    <textarea id='publicKey' placeholder='PublicKey' className='akeytxt1'
                    ></textarea>
                </div>
                <div>
                    <textarea id='privateKey' placeholder='PrivateKey' className='akeytxt2'
                    ></textarea>
                </div>
            </div>
