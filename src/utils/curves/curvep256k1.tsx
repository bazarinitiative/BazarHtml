...
export class curvep256k1 implements ICurve {
    async generateKeyPair(): Promise<BzKeyPair> {
        ...
        ret.privateKeyStr = prefixBzPriv + AlgoType.secp256k1 + hexToBase62(priv);
        ret.publicKeyStr = prefixBzPub + AlgoType.secp256k1 + hexToBase62(pub);
        return ret;
    }
    ...
    async derivePublicKey(privateKeyStr: string): Promise<string> {
        ...
        return prefixBzPub + AlgoType.secp256k1 + hexToBase62(pub);
    }
